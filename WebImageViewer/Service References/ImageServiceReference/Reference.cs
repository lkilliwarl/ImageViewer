...
namespace WebImageViewer.ImageServiceReference {
    ...
    public interface IImageService {
        ...
        WebImageViewer.ImageServiceReference.Image GetImage(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IImageService/GetImage", ReplyAction="http://tempuri.org/IImageService/GetImageResponse")]
        System.Threading.Tasks.Task<WebImageViewer.ImageServiceReference.Image> GetImageAsync(int id);
        ...
        WebImageViewer.ImageServiceReference.Image[] GetImages();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IImageService/GetImages", ReplyAction="http://tempuri.org/IImageService/GetImagesResponse")]
        System.Threading.Tasks.Task<WebImageViewer.ImageServiceReference.Image[]> GetImagesAsync();
        ...
        WebImageViewer.ImageServiceReference.Image[] FilterImages(string tagToFilter);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IImageService/FilterImages", ReplyAction="http://tempuri.org/IImageService/FilterImagesResponse")]
        System.Threading.Tasks.Task<WebImageViewer.ImageServiceReference.Image[]> FilterImagesAsync(string tagToFilter);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IImageServiceChannel : WebImageViewer.ImageServiceReference.IImageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ImageServiceClient : System.ServiceModel.ClientBase<WebImageViewer.ImageServiceReference.IImageService>, WebImageViewer.ImageServiceReference.IImageService {
        ...
        public WebImageViewer.ImageServiceReference.Image GetImage(int id) {
            return base.Channel.GetImage(id);
        }
        
        public System.Threading.Tasks.Task<WebImageViewer.ImageServiceReference.Image> GetImageAsync(int id) {
            return base.Channel.GetImageAsync(id);
        }
        
        public WebImageViewer.ImageServiceReference.Image[] GetImages() {
            return base.Channel.GetImages();
        }
        
        public System.Threading.Tasks.Task<WebImageViewer.ImageServiceReference.Image[]> GetImagesAsync() {
            return base.Channel.GetImagesAsync();
        }
        
        public WebImageViewer.ImageServiceReference.Image[] FilterImages(string tagToFilter) {
            return base.Channel.FilterImages(tagToFilter);
        }
        
        public System.Threading.Tasks.Task<WebImageViewer.ImageServiceReference.Image[]> FilterImagesAsync(string tagToFilter) {
